...
TOKEN = "699553124:AAE5tC0yycqOR9VRQE1R34gBkLw9xPINx0o"
...
@server.route("/")def webhook(): bot.remove_webhook() bot.set_webhook(url="https://glacial-sierra-56391.herokuapp.com/' + TOKEN) return "!", 200 
